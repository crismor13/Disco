...
public interface IAlbumService
{
    ...
    Task<BaseMessage<Album>> GetAlbumsAsync(bool areReferencesLoaded);
    ...
    /// <returns>A <see cref="List" /> of <see cref="Album"/> </returns>
    Task<BaseMessage<Album>> GetAlbumsByGenre(Genres genre);
    ...
    Task<BaseMessage<Album>> GetById(int id);
