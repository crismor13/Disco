...
public class TourService : ITourService
{
    ...
    private static BaseMessage<Tour> BuildResponse(HttpStatusCode statusCode, string message)
    {
    ...
    private static BaseMessage<Tour> BuildResponse(HttpStatusCode statusCode, string message, List<Tour> tours)
    {
        return new BaseMessage<Tour>{
            Message = message,
