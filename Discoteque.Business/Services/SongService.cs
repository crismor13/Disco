...
public class SongService : ISongService
{
    ...
    private static BaseMessage<Song> BuildResponse(HttpStatusCode statusCode, string message)
    {
    ...
    private static BaseMessage<Song> BuildResponse(HttpStatusCode statusCode, string message, List<Song> songs)
    {
        return new BaseMessage<Song>{
            Message = message,
